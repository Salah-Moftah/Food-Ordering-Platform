...
const createLineItems = (
  checkoutSessionRequest: CheckoutSessionRequest, // Contains cart items requested for the checkout session
  menuItems: MenuItemsType[] // Array of menu items available for reference
) => {
